...
export default class LevelB extends Phaser.Scene {
	...
	editorCreate() {
		...
		// clip_a
		const clip_a = this.add.video(640, 360, "2_1");

		// clip_b
		const clip_b = this.add.video(640, 360, "2_1");
		clip_b.visible = false;

		// clip_c
		const clip_c = this.add.video(640, 360, "2_3");
		clip_c.visible = false;

		// clip_d
		const clip_d = this.add.video(640, 360, "2_4");
		...
		// text_2
		const text_2 = this.add.text(204, 10, "", {});
		text_2.setOrigin(0.5, 0.5);
		text_2.text = "C. It manages day-to-day affairs and carries out the laws\n";
		...
		// text
		const text = this.add.text(176, 0, "", {});
		text.setOrigin(0.5, 0.5);
		text.text = "B. It creates laws and conducts court hearings";
		...
		// text_1
		const text_1 = this.add.text(182, 0, "", {});
		text_1.setOrigin(0.5, 0.5);
		text_1.text = "A. It reviews and revises laws made by Parliament";
		text_1.setStyle({ "color": "#000000ff", "fontFamily": "BebasNeue-Regular", "fontSize": "18px", "resolution": 2 });
		answe_a.add(text_1);

		// question
		const question = this.add.text(-37, -85, "", {});
		question.setOrigin(0.5, 0.5);
		question.text = "Which of the following best describes \nthe role of the Executive branch of government?\n";
		...
		interdutcion_discription.text = "His next thought was that Blue Mountain must be a safe bet,\nBut he slipped on a rock cause all him foot bottom did a sweat!";
		...
		interduction_Title.text = "Blue Mountain";
	...
	create() {
		...
		this.introductionSound = this.sound.add("level_b_interduction");
		...
		this.typeText(this.interduction_Title, "Blue Mountain", 100);

		// Add typing animation for description after title is complete
		this.time.delayedCall(1200, () => {
			this.typeText(
				this.interdutcion_discription, 
				"His next thought was that Blue Mountain must be a safe bet,\nBut he slipped on a rock—'cause all him foot bottom did a sweat!", 
				30
			);
		});
		...
		this.time.delayedCall(8000, () => {
			...
			this.tweens.add({
				...
				onComplete: () => {
					...
					this.interduction_Title.setText("Blue Mountain"); // Ensure text is fully displayed
					this.interdutcion_discription.setText("His next thought was that Blue Mountain must be a safe bet,\nBut he slipped on a rock—'cause all him foot bottom did a sweat!");

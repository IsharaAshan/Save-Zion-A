...
export default class LevelE extends Phaser.Scene {
	...
	editorCreate() {
		...
		// text_3
		const text_3 = this.add.text(177, 0, "", {});
		text_3.setOrigin(0.5, 0.5);
		text_3.text = "D. Approving budgets and overseeing procurement";
		...
		// text_2
		const text_2 = this.add.text(207, 2, "", {});
		text_2.setOrigin(0.5, 0.5);
		text_2.text = "C. Managing ministries and agencies that carry out policies";
		...
		// text
		const text = this.add.text(186, 5, "", {});
		text.setOrigin(0.5, 0.5);
		text.text = "B. Interpreting the Constitution and resolving legal \ndisputes";
		...
		// text_1
		const text_1 = this.add.text(178, -1, "", {});
		text_1.setOrigin(0.5, 0.5);
		text_1.text = "A. Creating new laws to respond to national needs";
		...
		question.text = "What is the main responsibility of the Judiciary in \nJamaica’s governance structure?";
		...
		interdutcion_discription.text = "His feet ran where they were familiar and so ended down by Back Road,\nHe hoped he would be safe because the girls there know the road code.";
		...
		interduction_Title.text = "Back Road";
	...
	create() {
		...
		this.introductionSound = this.sound.add("level_c_interduction");
		...
		this.typeText(this.interduction_Title, "Back Road", 100);

		// Add typing animation for description after title is complete
		this.time.delayedCall(1200, () => {
			this.typeText(
				this.interdutcion_discription, 
				"His feet ran where they were familiar and so ended down by Back Road,\nHe hoped he would be safe because the girls there know the road code.",
				30
			);
		});
		...
		this.time.delayedCall(8000, () => {
			...
			this.tweens.add({
				...
				onComplete: () => {
					...
					this.interduction_Title.setText("Back Road"); // Ensure text is fully displayed
					this.interdutcion_discription.setText("His feet ran where they were familiar and so ended down by Back Road,\nHe hoped he would be safe because the girls there know the road code.");
	...
	stopAllSounds() {
		...
		if (this.introductionSound) this.introductionSound.stop(); // Add this line to match LevelD

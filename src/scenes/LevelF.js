...
export default class LevelF extends Phaser.Scene {
	...
	editorCreate() {
		...
		// clip_a
		const clip_a = this.add.video(640, 360, "6_1");

		// clip_b
		const clip_b = this.add.video(640, 360, "6_2");
		clip_b.visible = false;

		// clip_c
		const clip_c = this.add.video(640, 360, "6_4");
		clip_c.visible = false;

		// clip_d
		const clip_d = this.add.video(640, 360, "6_3");
		...
		// text_3
		const text_3 = this.add.text(186, 9, "", {});
		text_3.setOrigin(0.5, 0.5);
		text_3.text = "D. The Attorney General leads court hearings in the \nSupreme Court";
		...
		// text_2
		const text_2 = this.add.text(203, 5, "", {});
		text_2.setOrigin(0.5, 0.5);
		text_2.text = "C. The Attorney General gives legal advice to government,\nwhile the Judiciary interprets and applies the law";
		...
		// text
		const text = this.add.text(209, 0, "", {});
		text.setOrigin(0.5, 0.5);
		text.text = "B. The Attorney General creates laws for Cabinet to review";
		...
		// text_1
		const text_1 = this.add.text(169, -3, "", {});
		text_1.setOrigin(0.5, 0.5);
		text_1.text = "A. The Attorney General settles legal \ndisputes between citizens and the government";
		...
		question.text = "How is the Attorney General’s role different from \nthe Judiciary?";
		...
		interdutcion_discription.text = "Champs was the perfect hiding place—noisy and filled with fans,\nBut still Babylon spotted him—hiding in the stands!";
		...
		interduction_Title.text = "Champs";
	...
	create() {
		...
		// Update title and description - initially empty
		this.interduction_Title.setText('');
		this.interdutcion_discription.setText('');

		// Load and play introduction sound
		this.introductionSound = this.sound.add("level_f_interduction");
		...
		// Add typing animation for title - keep as "Champs"
		this.typeText(this.interduction_Title, "Champs", 100);

		// Add typing animation for description after title is complete - keep original text
		this.time.delayedCall(1200, () => {
			this.typeText(
				this.interdutcion_discription, 
				 "Champs was the perfect hiding place—noisy and filled with fans,\nBut still Babylon spotted him—hiding in the stands!",
				30
			);
		});
		...
		this.time.delayedCall(9000, () => {
			...
			this.tweens.add({
				...
				onComplete: () => {
					...
					this.interduction_Title.setText("Champs"); // Ensure text is fully displayed
					this.interdutcion_discription.setText("Champs was the perfect hiding place—noisy and filled with fans,\nBut still Babylon spotted him—hiding in the stands!");
